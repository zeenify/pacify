...
const s = StyleSheet.create({
  ...
  slash: {
    ...
    ...(Platform.OS === "web" ? ({ animation: "p5-slashA 0.9s 0.15s cubic-bezier(0.16,1,0.3,1) both" } as any) : {}),
  } as any,
  slash2: {
    position: "absolute",
    top: "-10%",
    ...
    ...(Platform.OS === "web" ? ({ animation: "p5-slashB 0.9s 0.3s cubic-bezier(0.16,1,0.3,1) both" } as any) : {}),
  } as any,
